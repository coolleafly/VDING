...
def out3(of3):
    # Make TiTle
    of3.wt('ID', 'Chosen', 'SysErr','Screw')
    of3.wtln('AD','CGD','CVD','CLD','AGD','AVD','ALD','RDC','RDA')
    #Content
    for i in range(1,idN+1):
        t=mycase[i]
        SysErr=t.AveEU
        of3.wt(i, t.bestZuhe, SysErr)
...
of7=XYxlwt(path+'out3'+ex+'.xls')
out7(of7)
print('[out3.xls] File is OK!')

of3=XYxlwt(path+'out1'+ex+'.xls')
out3(of3)
print('[out1.xls] File is OK!')

of1=XYxlwt(path+'out2'+ex+'.xls')
out1(of1)
print('[out2.xls] File is OK!')
